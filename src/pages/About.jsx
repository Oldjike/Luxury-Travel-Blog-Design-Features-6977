  ...
  const team=[ 
    {
      name: "Seeta Chandra",
      role: "Founder & CEO",
      image: "https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1753217532044-blob",
            ...
            > 
              {[ 
                ...
                <motion.div 
                  key={index} 
                  whileHover={{y: -5}} 
                  className={`rounded-xl overflow-hidden shadow-lg ${index===0 || index===3 ? "row-span-2" : ""}`} 
                > 
                  <img 
                    src={image} 
